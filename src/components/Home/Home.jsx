...
import img from "../../assets/Card42x.jpg";
        ...
        <>
            ...
            <main className="content mt-20">
                <div className="heading">
                    <h1>Trello for Work</h1>
                    <div className="desc">
                        Whether the project is big or small, see how Trello can
                ...
                <div className="hero">
                    ...
                    <div className="desc-hero">
                        <div className="desc">
                            Trello boards, lists, and cards help teams quickly
                            go from idea to action. Intuitive and easy to use,
                            Trello helps teams bring projects to life and keep
                            growing.
                        </div>
                        <Button variant="Contained">Logout - Free</Button>
                    </div>
                </div>
            </main>
                    ...
                    <div className="mx-auto container pt-20 lg:pt-72 flex flex-col items-center justify-center">
                        ...
                        <div className="text-black flex flex-col md:items-center f-f-l pt-3">
                            ...
                            <div className="text-sm text-color mb-10 f-f-l">
                                <p> © 2023 Countduck2003. All rights reserved</p>
                            </div>
                        </div>
                        ...
                        <div className="flex justify-between items-center pt-12">
                            <div className="mr-4">
                                ...
                                >
                                    <g clipPath="url(#clip0)">
                                        ...
                                        />
                                        <path
                                            d="M30.0656 12.2108C30.8772 11.2366 31.277 9.98445 31.1802 8.72021C29.9403 8.85044 28.7951 9.44299 27.9726 10.3798C27.5704 10.8375 27.2624 11.3699 27.0662 11.9467C26.87 12.5235 26.7893 13.1333 26.8289 13.7412C27.449 13.7476 28.0625 13.6132 28.6232 13.3481C29.1838 13.083 29.6771 12.6942 30.0656 12.2108Z"
                                            fill="white"
                                        />
                                        <path
                                            d="M50.3308 27.1397H45.5974L44.4607 30.4961H42.4558L46.9392 18.0781H49.0222L53.5056 30.4961H51.4665L50.3308 27.1397ZM46.0876 25.5908H49.8396L47.99 20.1436H47.9383L46.0876 25.5908Z"
                                            fill="white"
                                        />
                                        <path
                                        ...
                                        />
                                        <path
                                            d="M91.3747 19.2998V21.4424H93.0964V22.9141H91.3747V27.9053C91.3747 28.6807 91.7195 29.042 92.4763 29.042C92.6807 29.0384 92.8848 29.0241 93.0876 28.999V30.4619C92.7474 30.5255 92.4015 30.5543 92.0554 30.5478C90.2224 30.5478 89.5076 29.8593 89.5076 28.1035V22.9141H88.1912V21.4424H89.5075V19.2998H91.3747Z"
                                            fill="white"
                                        />
                                        <path
                                            d="M94.0935 25.9697C94.0935 23.1211 95.7712 21.3311 98.3875 21.3311C101.012 21.3311 102.682 23.1211 102.682 25.9697C102.682 28.8262 101.021 30.6084 98.3875 30.6084C95.7546 30.6084 94.0935 28.8262 94.0935 25.9697ZM100.789 25.9697C100.789 24.0156 99.8933 22.8623 98.3874 22.8623C96.8816 22.8623 95.9871 24.0244 95.9871 25.9697C95.9871 27.9316 96.8816 29.0762 98.3874 29.0762C99.8933 29.0762 100.789 27.9316 100.789 25.9697H100.789Z"
                                            fill="white"
                                        />
                                        <path
                                            d="M104.215 21.4425H105.987V22.9835H106.03C106.15 22.5022 106.432 22.0769 106.829 21.779C107.225 21.4811 107.712 21.3288 108.208 21.3478C108.422 21.347 108.636 21.3703 108.845 21.4171V23.1554C108.574 23.0728 108.292 23.0348 108.01 23.0431C107.74 23.0321 107.47 23.0797 107.221 23.1826C106.971 23.2855 106.746 23.4412 106.562 23.6391C106.378 23.837 106.239 24.0724 106.155 24.3291C106.07 24.5857 106.042 24.8576 106.073 25.1261V30.4962H104.215L104.215 21.4425Z"
                                            fill="white"
                                        />
                                        <path
                                        ...
                                        />
                                        <path
                                            d="M59.6018 14.2607H58.6799L57.7493 10.9443H57.679L56.7522 14.2607H55.8391L54.5979 9.75781H55.4993L56.3059 13.1938H56.3723L57.2981 9.75781H58.1506L59.0764 13.1938H59.1467L59.9495 9.75781H60.8381L59.6018 14.2607Z"
                                            fill="white"
                                        />
                                        <path
                                        ...
                                        />
                                        <path
                                            d="M67.1223 8H68.011V14.2607H67.1223V8Z"
                                            fill="white"
                                        />
                                        <path
                                        ...
                                        />
                                        <path
                                            d="M101.544 8.63672V9.77832H102.519V10.5269H101.544V12.8423C101.544 13.314 101.738 13.5205 102.18 13.5205C102.294 13.5201 102.407 13.5133 102.519 13.5V14.2402C102.36 14.2688 102.198 14.284 102.036 14.2856C101.048 14.2856 100.654 13.938 100.654 13.0698V10.5268H99.9392V9.77828H100.654V8.63672H101.544Z"
                                            fill="white"
                                        />
                                        <path
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    />
                                    <path
                                        d="M52.0278 7.7373H49.2954V9.6396H51.7593V10.3604H49.2954V12.2627H52.0278V13H48.5249V7H52.0278V7.7373Z"
                                        fill="white"
                                        stroke="white"
                                        strokeWidth="0.2"
                                        strokeMiterlimit={10}
                                    />
                                    <path
                                        d="M55.2786 13H54.5071V7.7373H52.8313V7H56.9544V7.7373H55.2786V13Z"
                                        fill="white"
                                        stroke="white"
                                        strokeWidth="0.2"
                                        strokeMiterlimit={10}
                                    />
                                    <path
                                        d="M59.938 13V7H60.7085V13H59.938Z"
                                        fill="white"
                                        stroke="white"
                                        strokeWidth="0.2"
                                        strokeMiterlimit={10}
                                    />
                                    <path
                                        d="M64.1284 13H63.3569V7.7373H61.6812V7H65.8042V7.7373H64.1284V13Z"
                                        fill="white"
                                        stroke="white"
                                        strokeWidth="0.2"
                                        strokeMiterlimit={10}
                                    ...
                                    />
                                    <path
                                        d="M75.5752 13V7H76.5137L79.4297 11.6675H79.4629L79.4297 10.5112V7H80.2012V13H79.3965L76.3457 8.1064H76.3125L76.3457 9.2627V13H75.5752Z"
                                        fill="white"
                                        stroke="white"
                                        strokeWidth="0.2"
                                        strokeMiterlimit={10}
                                    ...
                                    />
                                    <path
                                        d="M10.4352 7.53818C10.1073 7.93025 9.9417 8.43287 9.97238 8.94308V31.0592C9.94161 31.5694 10.1072 32.072 10.4352 32.4641L10.5092 32.5362L22.8982 20.1473V19.855L10.5092 7.46558L10.4352 7.53818Z"
                                    ...
                                    />
                                    <path
                                        d="M27.0276 24.2787L22.8982 20.1473V19.855L27.0286 15.7246L27.1217 15.7777L32.0145 18.5578C33.4121 19.3518 33.4121 20.651 32.0145 21.4455L27.1217 24.2256L27.0276 24.2787Z"
                                    ...
                                    />
                                    <path
                                        d="M27.1218 24.2251L22.8983 20.0012L10.4353 32.4641C10.7201 32.7153 11.0837 32.8589 11.4633 32.8701C11.8428 32.8813 12.2143 32.7594 12.5134 32.5255L27.1218 24.2251Z"
                                    ...
                                    />
                                    <path
                                        d="M27.1218 15.7771L12.5134 7.47666C12.2143 7.24275 11.8428 7.12084 11.4633 7.13206C11.0837 7.14327 10.7201 7.2869 10.4353 7.53806L22.8983 20.0011L27.1218 15.7771Z"
                                    ...
                                    <path
                                        opacity="0.2"
                                        d="M27.0287 24.1321L12.5134 32.3794C12.2258 32.5983 11.8748 32.7178 11.5134 32.7197C11.152 32.7216 10.7997 32.6059 10.5098 32.3901L10.4353 32.4646L10.5093 32.5367L10.5098 32.5362C10.7997 32.7521 11.1519 32.8679 11.5134 32.866C11.8749 32.864 12.2259 32.7445 12.5134 32.5255L27.1218 24.2251L27.0287 24.1321Z"
                                        fill="black"
                                    />
                                    <path
                                        opacity="0.12"
                                        d="M10.4354 32.3185C10.1075 31.9264 9.94195 31.4238 9.97261 30.9136V31.0597C9.94194 31.5699 10.1075 32.0725 10.4354 32.4646L10.5099 32.3901L10.4354 32.3185Z"
                                        fill="black"
                                    />
                                    <path
                                        opacity="0.12"
                                        d="M32.0147 21.2988L27.0288 24.132L27.1219 24.225L32.0147 21.4449C32.3025 21.32 32.5516 21.1202 32.736 20.8663C32.9203 20.6125 33.0333 20.3138 33.063 20.0015C33.0011 20.2843 32.8742 20.5488 32.6922 20.774C32.5102 20.9992 32.2783 21.1789 32.0147 21.2988Z"
                                        fill="black"
                                    />
                                    <path
                                        opacity="0.25"
                                        d="M12.5133 7.62334L32.0145 18.7033C32.2782 18.8232 32.5102 19.0029 32.6922 19.2282C32.8742 19.4535 33.0011 19.7182 33.0628 20.0011C33.0333 19.6887 32.9204 19.3899 32.736 19.1359C32.5516 18.8819 32.3025 18.6821 32.0145 18.5572L12.5133 7.47724C11.1157 6.68314 9.97241 7.34274 9.97241 8.94354V9.08964C9.97241 7.48894 11.1157 6.82934 12.5133 7.62334Z"
                                        fill="white"
                                    />
                                    <defs>
                                        <linearGradient
